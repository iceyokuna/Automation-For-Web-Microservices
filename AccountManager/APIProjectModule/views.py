...
class WorkflowView(APIView):
    ...
    def post(self, request):
        ...
        workflow = Workflow.objects.create(user=request.user, bpmnJson=request.data.get('bpmnJson'), name=request.data.get('name'), description=request.data.get(
            'description'), appliedMethods=request.data.get('appliedMethods'), appliedAsyncs=request.data.get('appliedAsyncs'), appliedConditions=request.data.get('appliedConditions'),  appliedPreInputs=request.data.get('appliedPreInputs'), generatedForms=request.data.get('generatedForms'), appliedTimers=request.data.get('appliedTimers'))
